...
class DatabaseManager:
    ...
    async def get_connection(self):
        ...
        for attempt in range(retries):
            try:
                ...
                logger.info(f"{self.pool.size},{self.pool.freesize}")
    ...
    async def get_connection_new(self):
        """
        Acquires a connection from the pool with retry logic.
        ...
        for attempt in range(retries):
            try:
                ...
                logger.info(f"Pool size: {self.pool.size}, Free connections: {self.pool.freesize}")

                # Use async with to automatically release connection
